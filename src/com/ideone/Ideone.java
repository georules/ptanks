...
import com.ideone.exceptions.AuthException;
import com.ideone.exceptions.DataException;
...
public class Ideone{
	...
	String user = "Georules";
	String pass = "testing555api";
     ...
     * @throws AuthException 
     */
    public Hashtable<Integer,String> getLanguages() throws AuthException {
